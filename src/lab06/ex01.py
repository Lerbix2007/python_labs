...
"  python3 -m src.lab06.ex01 cat --input data/samples/people.csv -n   "
"  python3 -m src.lab06.ex01 stats --input  data/samples/people.csv --top 5   "
"  python3 -m src.lab06.ex01 --help  "